...
})({"1YAAK":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3799d23a2b165d7f";
"use strict";
...
},{}],"41UdK":[function(require,module,exports) {
/**@jsx ReactClon */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _setup = require("../src/setup");
var _setupDefault = parcelHelpers.interopDefault(_setup);
var _stylesCss = require("./styles.css");
function Buttom({ setIndex }) {
    return ReactClon("button", {
        onClick: ()=>alert("hola mundo")
    }, "Haz clic aqu\xed");
}
function ReactClon(type, props, ...args) {
...
(0, _setupDefault.default).render(ReactClon(Subtitle, {
    text: "hola"
}), document.querySelector("#app"));

},{"./styles.css":"iARSW","@parcel/transformer-js/src/esmodule-helpers.js":"fF8Uh","../src/setup":"YzXhw"}],"iARSW":[function() {},{}],"fF8Uh":[function(require,module,exports) {
...
},{}],"YzXhw":[function(require,module,exports) {
...
class ReactClone {
    ...
    static run(node) {
        ...
        if (node.props) Object.keys(node.props).map((key)=>{
        ...
        if (node.props && node.props.className) element.setAttribute("class", node.props.className);
        node.children.forEach((child)=>{
            if (typeof child === "string") return element.appendChild(document.createTextNode(node.children));
...
//# sourceMappingURL=index.2b165d7f.js.map
